 ...
 *******************************************************************************/
package com.ifeng_tech.treasuryyitong.pull;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static final int SMOOTH_SCROLL_DURATION_MS = 250; // 200
	public static final int SMOOTH_SCROLL_LONG_DURATION_MS = 375; //325
	static final int DEMO_SCROLL_INTERVAL = 275; // 225
	...
	@Override
	public final com.ifeng_tech.treasuryyitong.pull.ILoadingLayout getLoadingLayoutProxy() {
		return getLoadingLayoutProxy(true, true);
	}

	@Override
	public final com.ifeng_tech.treasuryyitong.pull.ILoadingLayout getLoadingLayoutProxy(boolean includeStart, boolean includeEnd) {
	...
	public final boolean isPullToRefreshOverScrollEnabled() {
		return VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD && mOverScrollEnabled
				&& com.ifeng_tech.treasuryyitong.pull.OverscrollHelper.isAndroidOverScrollEnabled(mRefreshableView);
	}
