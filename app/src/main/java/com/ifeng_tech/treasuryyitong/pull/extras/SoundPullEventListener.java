 ...
 *******************************************************************************/
package com.ifeng_tech.treasuryyitong.pull.extras;
...
public class SoundPullEventListener<V extends View> implements PullToRefreshBase.OnPullEventListener<V> {
	...
	private final HashMap<com.ifeng_tech.treasuryyitong.pull.PullToRefreshBase.State, Integer> mSoundMap;
	...
	public SoundPullEventListener(Context context) {
		mContext = context;
		mSoundMap = new HashMap<com.ifeng_tech.treasuryyitong.pull.PullToRefreshBase.State, Integer>();
	}
