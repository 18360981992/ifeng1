        ...
        my_warehouse_MyListView2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(intent.getStringExtra("select").equals("转赠")){
                    QR_Bean userCode = new QR_Bean(intent.getStringExtra("userCode"), new QR_Bean.GoodsInfo(listBean.getGoodsId(), listBean.getGoodsCode(), listBean.getGoodsName(), ""));
    ...
    public void setWarehouseAdapter() {
        if (list.size() > 0) {
            ...
            if (warehouse_adapter == null) {
                warehouse_adapter = new Warehouse_Adapter(My_Warehouse_Activity2.this, list,warehouseBean);
...
//        my_warehouse_zhangdan2 = (ImageView) findViewById(R.id.my_warehouse_zhangdan2);
        ...
        initRefreshListView(my_warehouse_pulltoscroll2);
    }
